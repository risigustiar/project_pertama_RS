...
<body>
    ...
    <h3><i class="fas fa-user-graduate mr-2"></i> Ubah Data Dosen</h3>
    <hr>
    <form action="update_dsn.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-4">
                <label>NIDN</label>
                <input type="text" name="nidn" class="form-control" id="nidn" value="<?php echo $nidn; ?>">
            </div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label>JABATAN</label>
                <input type="text" name="jabatan" class="form-control" id="jabatan" value="<?php echo isset($jabatan) ? htmlspecialchars($jabatan, ENT_QUOTES, 'UTF-8') : ''; ?>">
            </div>
        </div>
