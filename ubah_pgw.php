...
$result = mysqli_query($koneksi, "SELECT * FROM pegawai WHERE nik='$nik'");
...
<body>
    ...
    <h3><i class="fas fa-user-graduate mr-2"></i> Ubah Data </h3>Pegawai
    <hr>
    <form action="update_pgw.php" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label>BAGIAN</label>
                <input type="text" name="bagian" class="form-control" id="bagian" value="<?php echo isset($bagian) ? $bagian : ''; ?>">
            </div>
        </div>
